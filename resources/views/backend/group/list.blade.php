                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            ...
                            <div class="col-4">
                                <a href="{{ route('group.add') }}" class="btn btn-block btn-primary btn-lg">Thêm mới</a>
                            </div>
                        </div>
                                    ...
                                    <table id="example2" class="table table-bordered table-hover dataTable dtr-inline yajra-datatable w-100" role="grid" aria-describedby="example2_info">
                                        <thead>
                                            <tr role="row">
                                                ...
                                                <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending">Tráng thái</th>
